...
Original file is located at
    https://colab.research.google.com/drive/1QiaduDRuwn3e08PopOsIGlKiGgdIvMWs
"""
...
def testEndpointsReuse():
    inputs = create_test_input(2, 299, 299, 3)
    with slim.arg_scope(xception_arg_scope()):
      _, end_points0 = xception_65(
          inputs,
          num_classes=10,
          output_stride=8,
          reuse=tf.AUTO_REUSE)
    print("xception os=8")
    pp.pprint(end_points0)
