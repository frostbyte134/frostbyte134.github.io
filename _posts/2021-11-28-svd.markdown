...
1. row들에 대한 best fit subspace를 찾는 문제로 - [아이패드 노트필기 문서 참고](https://drive.google.com/file/d/1-KVYlnwD2i5yrhkbWPi0w2n6VMSOtGzQ/view?usp=sharing). Matrix norm (Frobenious, l2)관점에서 SVD가 최적의 (norm을 가장 잘 보존하는) rank-K approximation이란 것 까지 스무스하게 보일 수 있음
